Your job is to write or improve the preprocessing code for a BM25 index. The documents you will parse are from a dataset with the following information:
{dataset_info}
...
NEVER EDIT ANYTHING OUTSIDE OF THE src/agents/gemini_sdk FOLDER. DO NOT TOUCH ANY TESTS OR ANYTHING ELSE.