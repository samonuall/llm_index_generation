...
class Preprocessor(BasePreprocessor):
    name = "analysis_code_agent_dense"  # MUST BE EXACTLY THIS - DO NOT MODIFY
    description = "Extract plot, cast, and scene keywords as separate chunks to improve dense-retrieval matching for scene-specific queries."
    ...
    def preprocess(self, docs: List[Document]) -> List[Chunk]:
        ...
        for doc in docs:
            ...
            if plot_text:
                ...
                # This creates a strong signal for the dense retriever that this chunk contains narrative detail
                ...
                # which helps the dense retriever match queries that describe specific plot moments
