...
Uses LiteLLM to call a model that can invoke dense-retrieval / file tools to
investigate dense (Qwen3 embedding) retrieval failures and produce a structured
analysis summary.
"""
...
class AnalysisAgent:
        ...
        for turn in range(self._max_turns):
            ...
            if self._use_tools and tool_turns < self._min_tool_turns:
                nudge = (
                    ...
                    f"(dense_retrieve, read_file, grep_search) before providing your summary."
                )
    ...
    def _build_initial_context(
        ...
        tool_section = (
            ...
            f"1. **dense_retrieve(query, top_k=10)** — "
            f"Query the current dense (Qwen3 embedding) retrieval index. "
            f"Returns doc_id, cosine-similarity score, and rank for each result.\n"
