...
Usage examples:
  python src/agents/analysis_code_agent_dense/analysis_tools/read_documents.py --doc-ids 12095072:0 12095072:1
  python src/agents/analysis_code_agent_dense/analysis_tools/read_documents.py --doc-ids-file /tmp/doc_ids.txt --chars 1200
"""
...
def _project_root() -> pathlib.Path:
    # .../src/agents/analysis_code_agent_dense/analysis_tools/read_documents.py -> project root
