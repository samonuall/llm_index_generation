"""
eval_utils.py - Partial evaluation utilities using the dense-retrieval HTTP client.
...
def run_subset_eval(
    ...
    """
    Query the dense-retrieval server for the given queries against a named index.
    Computes recall@10, recall@100, nDCG@10 from the ranked results.

    Args:
        index_name: Name of the index on the server.
        queries: List of EvalQuery objects (query_id, query_text, relevant_doc_ids).
        client: DenseClient instance.
